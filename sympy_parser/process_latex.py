...
def process_sympy(sympy):
    #parsing_logger.info("Input sympy: %s" %(sympy))
    ...
    t1 = time.time()
    #parsing_logger.info("Output sympy: %s" %(sympy))
    #parsing_logger.info("Sympy processing time: %g" %(t1 - t0))
    return sympy
...
def test_sympy():
    ...
    print process_sympy("(dx)/(dy) \int y x**(2) d y")
    print process_sympy("(dx)/(dy) 5")
    print process_sympy("(d)/(dx) \int x**(2) d x")
    print process_sympy("(dx)/(dy) \int x**(2) d x")
    print process_sympy("(d)/(dy) x**(2) + x y = 0")
    print process_sympy("(d)/(dy) x**(2) + x y = 2")
    print process_sympy("(d x**(3))/(dy)")
    print process_sympy("(d x**(3))/(dy) + x**3")
